...
function Calculate(){
    ...
    chartGraph(graphic[0], graphic[1], graphic[2], graphic[3], graphic[4], graphic[5], graphic[6], graphic[7]);
}
...
},{"Chart.js":2,"progressbar.js":5}],2:[function(require,module,exports){
/*!
 * Chart.js v3.5.1
